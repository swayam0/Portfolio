    ...
    <SectionPanel>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        <div className="md:col-span-2">
          ...
          <p className="text-[#888] font-light leading-relaxed text-lg">
            My current technical focus lies heavily in Next.js, FastAPI, and building resilient LangChain/RAG pipelines. I enjoy operating across the entire stack, from writing multi-agent workflows to polishing glassmorphic UIs. Right now, I&apos;m splitting my time across freelance client work, product validation (ShipProof), and campus placement prep.
          </p>
        </div>
      ...
      <div className="pt-8 border-t border-white/5">
        ...
        <div className="flex flex-wrap gap-3">
          <span className="px-4 py-2 rounded-full bg-[#111] border border-white/10 text-[#888] text-sm">Freelancing</span>
